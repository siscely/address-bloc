...
<<<<<<< HEAD
    ...
    describe "#import_from_csv" do
     ...
     it "imports the 1st entry" do
       ...
       check_entry(entry_one, "Mark", "555-555-4268", "Mark@blocmail.com")
     end
      ...
      it "imports the 3rd entry" do
       ...
       check_entry(entry_two, "William", "265-832-9680", "William@blocmail.com")
     end
     ...
     it "imports the 2nd entry" do
       ...
       check_entry(entry_three, "Ryan", "282-469-5350", "Ryan@blocmail.com")
     end
  end
